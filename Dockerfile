...
ENV VITE_RAGNAROK_ADMIN_ACCOUNT=ragnaroktestnet
ENV VITE_RAGNAROK_ADMIN_OPERATOR_ACCOUNT=ragp2p
ENV VITE_RAGNAROK_GENESIS_ACCOUNT=ragnaroktestnet
ENV VITE_RAGNAROK_TREASURY_ACCOUNT=ragp2p
ENV VITE_RAGNAROK_INDEX_ACCOUNT=ragp2p
ENV VITE_NFT_ART_BASE_URL=https://dhenz14.github.io/norse-mythos-card-game
ENV VITE_EXTERNAL_URL_BASE=https://testnetdev.ragnaroknft.quest
ENV VITE_SEASON_START=2026-06-14T23:28:54Z
ENV VITE_RAGNAROK_INDEX_START_BLOCK=109016418
ENV RAGNAROK_PROTOCOL_ID=rk_game_testnet
ENV RAGNAROK_RESET_EPOCH=alfa-testnet-full-nft-2026-05-22
ENV RAGNAROK_ADMIN_OPERATOR_ACCOUNT=ragp2p
ENV RAGNAROK_INDEX_ACCOUNT=ragp2p
