...
ARG VITE_P2P_WEBRTC_ENABLED=false
ARG VITE_P2P_WS_FALLBACK_ENABLED=true
ARG VITE_P2P_STUN_URL=stun:testnetdev.ragnaroknft.quest:3478
...
ENV VITE_P2P_WEBRTC_ENABLED=$VITE_P2P_WEBRTC_ENABLED
ENV VITE_P2P_WS_FALLBACK_ENABLED=$VITE_P2P_WS_FALLBACK_ENABLED
ENV VITE_P2P_STUN_URL=$VITE_P2P_STUN_URL
