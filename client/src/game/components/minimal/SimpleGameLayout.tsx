  ...
  return (
    <div className="w-full h-full bg-amber-900">
      <div className="game-grid-container w-full h-full">
        ...
        <GameAreaContainer areaType="opponent" className="bg-amber-800/30">
          <div className="p-4">
        ...
        <GameAreaContainer areaType="battlefield" className="bg-amber-700/20">
          <div className="p-4">
        ...
        <GameAreaContainer areaType="player" className="bg-amber-800/30">
          <div className="p-4">
