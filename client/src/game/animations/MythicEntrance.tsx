 ...
 * MythicEntrance.tsx
 * 
 * Creates a cinematic camera movement and visual effect when mythic
...
interface MythicEntranceProps {
  card: CardData;
  position: Position;
  onComplete?: () => void;
}

const MythicEntrance: React.FC<MythicEntranceProps> = ({
  card,
  position,
  onComplete
}) => {
