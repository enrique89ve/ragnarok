/**
 * Iconic mythic cards
 * A collection of some of the most memorable mythics from the classic sets and expansions
 */
 ...
 */
export const   iconicMythicCards: CardData[] = [{
      id: 95101,
...
export default iconicMythicCards;
