...
export const necromancerCards: CardData[] = [
...

  {
    ...
    attack: 3,
    health: 6,
    description: "Deathrattle: Summon two 2/1 Skeletons with Rush.",
  ...
  },
  {
    ...
    attack: 6,
    health: 8,
    description: "Battlecry: Summon a copy of every Undead that died this game (up to 4).",
  ...
  },
  {
    ...
    attack: 5,
    health: 7,
    description: "Whenever a minion dies, gain +2 Attack.",
