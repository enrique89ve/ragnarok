...
export const druidCards: CardData[] = [
  ...
  },
  {
    ...
    attack: 4,
    health: 6,
    description: "Battlecry: Gain +1/+1 for each other minion you control.",
  ...
  },
  {
    ...
    attack: 5,
    health: 8,
    description: "At the end of your turn, restore 2 Health to all friendly characters.",
  ...
  },
  {
    ...
    attack: 2,
    health: 5,
    description: "Spellburst: Gain +2/+2.",
  ...
  },
  {
    ...
    attack: 3,
    health: 2,
    description: "After this attacks a minion, draw a card.",
  ...
  },
  {
    ...
    attack: 5,
    health: 5,
    description: "Battlecry: Copy a spell in your hand.",
  ...
  },
  {
    ...
    type: "minion",
    rarity: "common",
    description: "Choose One: Give adjacent minions +2/+2; or Summon a copy of this minion.",
