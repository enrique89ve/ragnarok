...
export const rogueCards: CardData[] = [
  ...
  },
  {
    ...
    type: "minion",
    rarity: "rare",
    description: "After this attacks, gain Stealth.",
...

  {
    ...
    attack: 5,
    health: 5,
    description: "Battlecry: Add 3 random spells from other classes to your hand. They cost (2) less.",
  ...
  },
  {
    ...
    attack: 7,
    health: 5,
    description: "Combo: Destroy an enemy minion. Deathrattle: Add a copy to your hand.",
...

  {
    ...
    attack: 2,
    health: 1,
    description: "Battlecry: The next card you play this turn has Stealth.",
  ...
  },
  {
    ...
    attack: 3,
    health: 2,
    description: "After this attacks and kills a minion, gain Stealth.",
  ...
  },
  {
    ...
    attack: 4,
    health: 3,
    description: "After this attacks, deal 2 damage to the adjacent minions.",
  ...
  },
  {
    ...
    attack: 5,
    health: 4,
    description: "Combo: Deal 3 damage to an enemy minion.",
  ...
  },
  {
    ...
    attack: 4,
    health: 5,
    description: "Deathrattle: Add a random Rogue spell to your hand. It costs (0).",
