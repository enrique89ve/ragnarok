...
export const deathknightCards: CardData[] = [
...

  {
    ...
    attack: 4,
    health: 5,
    description: "Deathrattle: Deal damage equal to this minion's Attack to a random enemy.",
  ...
  },
  {
    ...
    manaCost: 7,
    description: "Deal 8 damage split among all enemies. Freeze any that survive.",
  ...
  },
  {
    ...
    attack: 7,
    health: 7,
    description: "Battlecry: Deal 3 damage to all enemy minions. Deathrattle: Resummon this with 1 Health.",
