...
export const paladinCards: CardData[] = [
  {
    ...
    attack: 6,
    health: 6,
    description: "Deathrattle: Equip a 5/3 Luminous Blade.",
  ...
  },
  {
    ...
    type: "minion",
    rarity: "mythic",
    description: "Deathrattle: Equip a 5/2 Corrupted Ashbringer that gives your other minions +2 Attack.",
  ...
  // === Spellburst Card ===
  {
    ...
    type: "minion",
    rarity: "epic",
    description: "Spellburst: Gain Divine Shield.",
  ...
  },
  {
    ...
    attack: 2,
    health: 4,
    description: "Battlecry: Gain +1 Attack for each other friendly minion with Divine Shield.",
  ...
  },
  {
    ...
    attack: 3,
    health: 3,
    description: "After this minion loses Divine Shield, gain +2/+2.",
  ...
  },
  {
    ...
    attack: 6,
    health: 8,
    description: "Battlecry: Set all enemy minions' Attack to 1.",
