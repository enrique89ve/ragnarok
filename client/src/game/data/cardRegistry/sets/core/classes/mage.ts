...
export const mageCards: CardData[] = [
  ...
  },
  {
    ...
    name: "Runic Barrage",
    manaCost: 1,
    description: "Deal 3 damage split among all enemy characters.",
  ...
  // === Spellburst Card ===
  {
    ...
    type: "minion",
    rarity: "common",
    description: "Spellburst: Deal 4 damage split among all enemy minions.",
  ...
  // === Seidr & Spell Damage Expansion ===
  {
    ...
    name: "Runestorm",
    manaCost: 1,
    description: "Deal 3 damage split among all enemies.",
