...
export const berserkerCards: CardData[] = [
  ...
  },
  {
    ...
    attack: 10,
    health: 6,
    description: "Dormant for 2 turns. When this awakens, deal 10 damage split among all enemies.",
  ...
  },
  {
    ...
    type: "minion",
    rarity: "common",
    description: "At the end of your turn, deal 6 damage split among all enemies.",
  ...
  },
  {
    ...
    attack: 4,
    health: 3,
    description: "After this attacks and kills a minion, gain +2 Attack.",
  ...
  },
  {
    ...
    attack: 5,
    health: 7,
    description: "Battlecry: Gain Armor equal to your hero's Attack.",
  ...
  },
  {
    ...
    attack: 4,
    health: 4,
    description: "Overkill: Draw a card.",
  ...
  },
  {
    ...
    attack: 3,
    health: 5,
    description: "Has +2 Attack while your hero is damaged.",
  ...
  },
  {
    ...
    attack: 8,
    health: 6,
    description: "Battlecry: Deal damage equal to your hero's Attack to a minion.",
  ...
  // === Lifesteal & Outcast Expansion ===
  {
    ...
    attack: 3,
    health: 4,
    description: "Outcast: Gain +2 Attack.",
  ...
  },
  {
    ...
    attack: 4,
    health: 6,
    description: "After this attacks and kills a minion, gain +2/+2.",
  ...
  },
  {
    ...
    attack: 5,
    health: 7,
    description: "Outcast: Deal 5 damage to all enemy minions.",
