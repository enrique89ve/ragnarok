...
export const shamanCards: CardData[] = [
  ...
  },
  {
    ...
    type: "minion",
    rarity: 'epic',
    description: "Deathrattle: Shuffle 'The Storm Guardian' into your deck.",
  ...
  },
  {
    ...
    attack: 3,
    health: 6,
    description: "Battlecry: Deal 1 damage to all minions. Overload: (1)",
  ...
  // === Echo Card ===
  {
    ...
    type: "minion",
    rarity: "common",
    description: "Battlecry: Add a random Shaman spell to your hand.",
