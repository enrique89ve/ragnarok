...
export const hunterCards: CardData[] = [
  ...
  },
  {
    ...
    attack: 5,
    health: 6,
    description: "At the end of your turn, if you control at least 2 other Beasts, summon a 1/1 Hound with Charge.",
  ...
  // === Dormant Card ===
  {
    ...
    rarity: "common",
    race: "Beast",
    description: "Dormant for 2 turns. Attacks a random enemy after this awakens.",
  ...
  },
  {
    ...
    rarity: "epic",
    race: "Beast",
    description: "Overkill: Summon a copy of this minion.",
