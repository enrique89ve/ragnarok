...
export const primordialExpansionCards: CardData[] = [
	...
	},
	{
		...
		class: 'Neutral',
		race: 'Titan',
		description: 'If Odin-Spark and Ve-Spark survive until your next turn, merge into Aesir Ascendant.',
		keywords: ['taunt'],
		collectible: false,
	...
	},
	{
		...
		class: 'Neutral',
		race: 'Titan',
		description: 'Spell Damage +1. Adjacent minions have +1 Attack.',
...

	{
		...
		attack: 8,
		health: 10,
		description: 'Trio Pact: Requires all 3 Hecatoncheires in hand. Summons all three, destroys your hand and friendly minions. End of turn: Deal 3 damage split among all enemies.',
...

	{
		...
		attack: 7,
		health: 12,
		description: 'Trio Pact: Requires all 3 Hecatoncheires in hand. Summons all three, destroys your hand and friendly minions. Enemy minions cost (2) more. End of turn: Freeze a random enemy minion.',
...

	{
		...
		attack: 9,
		health: 12,
		description: 'Trio Pact: Requires all 3 Hecatoncheires in hand. Summons all three, destroys your hand and friendly minions. Can\'t be targeted by spells or Hero Powers. Start of turn: All enemy minions lose 1 Attack permanently.',
	...
	},
	{
		...
		description: 'Battlecry: Submerge for 1 turn. Surface: Gain Divine Shield.',
