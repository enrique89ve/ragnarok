...
export const prophecyPayoffCards: CardData[] = [
	...
	},
	{
		...
		attack: 1,
		health: 4,
		description: 'Gains +1/+1 each time a Prophecy countdown ticks.',
...
export const realmShiftPayoffCards: CardData[] = [
	...
	},
	{
		...
		attack: 4,
		health: 7,
		description: 'Battlecry: If you shifted realms twice this game, gain +3/+3 and Divine Shield.',
...
export const bloodEchoCards: CardData[] = [
	...
	},
	{
		...
		attack: 5,
		health: 4,
		description: 'Blood Echo. When this dies, add a 0-cost copy to your hand that costs 5 Health to play.',
...
export const ragnarokThresholdCards: CardData[] = [
	...
	},
	{
		...
		attack: 4,
		health: 7,
		description: 'Ragnarok Threshold: If your hero has 30 HP or below, gain +4 Attack and Rush.',
...
export const valhallasCallCards: CardData[] = [
	...
	},
	{
		...
		attack: 3,
		health: 5,
		description: 'Einherjar. Valhalla\'s Call: After this has died and returned 3 times, give all friendly minions +2/+2.',
...
export const activeWagerCards: CardData[] = [
	...
	},
	{
		...
		attack: 5,
		health: 7,
		description: 'Wager: Whenever you win a showdown, draw a card and deal 2 damage to the enemy hero.',
