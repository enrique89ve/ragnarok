...
export const greekMythicMinions: CardData[] = [
	{
		...
		class: 'Neutral',
		race: 'Beast',
		description: 'Attacks 3 times per turn (one for each head). Can\'t be targeted by spells.',
	...
	},
	{
		...
		class: 'Neutral',
		race: 'Titan',
		description: 'At the end of each turn, summon a 2/2 Serpent Head.',
		keywords: ['taunt'],
		collectible: true,
	...
	},
	{
		...
		class: 'Neutral',
		race: 'Titan',
		description: 'All other friendly minions have +3 Attack.',
		keywords: ['taunt'],
		collectible: true,
	...
	},
	{
		...
		rarity: 'rare',
		race: 'Beast',
		description: 'Can\'t be targeted by spells while other friendly minions exist.',
	...
	},
	{
		...
		rarity: 'epic',
		race: 'Beast',
		description: 'Deathrattle: Summon a 3/3 Lion and a 3/3 Serpent.',
