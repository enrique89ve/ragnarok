...
// ============================================
// NEUTRAL MYTHIC MINIONS (from mythicCards.ts)
// ============================================
export const neutralMythicMinions: CardData[] = [];

// ============================================
// CLASS MYTHIC MINIONS (from mythicCards.ts)
// ============================================
export const classMythicMinions: CardData[] = [
  {
    id: 20006,
...
// MYTHIC HERO CARDS
// ============================================
export const mythicHeroCards: CardData[] = [];

// ============================================
// MYTHIC WEAPONS
// ============================================
export const mythicWeapons: CardData[] = [];

// ============================================
// MYTHIC SPELLS
// ============================================
export const mythicSpells: CardData[] = [];

// ============================================
// MYTHIC TOKENS
// ============================================
export const mythicTokens: CardData[] = [];

export const allMythicCards: CardData[] = [
  ...neutralMythicMinions,
  ...classMythicMinions,
  ...mythicHeroCards,
  ...mythicWeapons,
  ...mythicSpells,
