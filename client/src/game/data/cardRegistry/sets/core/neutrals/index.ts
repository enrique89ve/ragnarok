...
const commonNeutralMinions: CardData[] = [
  ...
  },
  {
    ...
    description: 'Battlecry: Deal 5 damage to this minion.',
  ...
  },
  {
    ...
    description: 'Battlecry: Add a 1/1 Spark with Rush to your hand.',
  ...
  },
  {
    ...
    description: 'Overkill: Gain 3 Armor.',
...
const rareNeutralMinions: CardData[] = [
  ...
  },
  {
    ...
    description: 'Costs (1) less for each spell you have cast this game.',
...
const epicNeutralMinions: CardData[] = [
  ...
  },
  {
    ...
    description: "Deathrattle: Deal this minion's Attack damage split among all enemies.",
...
const mythicNeutralMinions: CardData[] = [
  ...
  },
  {
    ...
    type: 'minion',
    rarity: 'epic',
    description: 'Battlecry: Deal 2 damage to all enemies.',
  ...
  },
  {
    ...
    type: 'minion',
    rarity: 'epic',
    description: 'Deathrattle: Deal 4 damage to a random enemy.',
  ...
  },
  {
    ...
    type: 'minion',
    rarity: 'epic',
    description: 'Deathrattle: Restore all friendly minions to full Health.',
  ...
  },
  {
    ...
    type: 'minion',
    rarity: 'common',
    description: 'After this attacks and kills a minion, add a copy of it to your hand.',
  ...
  },
  {
    ...
    type: 'minion',
    rarity: 'rare',
    description: 'After a minion dies, gain +1/+1.',
  ...
  },
  {
    ...
    type: 'minion',
    rarity: 'epic',
    description: 'Battlecry: Summon a 4/4 Wolf with Rush.',
  ...
  },
  {
    ...
    type: 'minion',
    rarity: 'rare',
    description: 'Battlecry: Give your other minions Stealth for one turn.',
  ...
  },
  {
    ...
    type: 'minion',
    rarity: 'rare',
    description: 'Battlecry: Your hero is Immune this turn.',
  ...
  },
  {
    ...
    type: 'minion',
    rarity: 'rare',
    description: 'At the end of your turn, summon a 2/2 Hell Pup.',
  ...
  },
  {
    ...
    type: 'minion',
    rarity: 'epic',
    description: 'Deathrattle: Destroy an enemy minion.',
  ...
  },
  {
    ...
    type: 'minion',
    rarity: 'rare',
    description: 'After this attacks a hero, gain +2 Attack.',
  ...
  },
  {
    ...
    type: 'minion',
    rarity: 'rare',
    description: 'Battlecry: Summon a 2/1 Harpy.',
  ...
  },
  {
    ...
    type: 'minion',
    rarity: 'rare',
    description: 'After this kills a minion, give another friendly minion Rush.',
  ...
  },
  {
    ...
    description: 'Battlecry: Foresee a Taunt minion.',
    manaCost: 3,
    type: 'minion',
    attack: 1,
    health: 4,
  ...
  },
  {
    ...
    name: 'Heavy Plate',
    manaCost: 3,
    description: 'Give a minion +3 Health and Taunt.',
    rarity: 'common',
    type: 'spell',
    keywords: ['tradeable'],
    class: 'Neutral',
  ...
  },
  {
    ...
    attack: 2,
    health: 3,
    description: 'Battlecry: Reduce the Cost of a random card in your hand by (2).',
    rarity: 'common',
    type: 'minion',
    keywords: ['tradeable', 'battlecry'],
    class: 'Neutral',
  ...
  },
  {
    ...
    attack: 2,
    health: 5,
    description: 'Battlecry: Equip a 3/2 Sword. Corrupt: A 5/2 Sword.',
    rarity: 'rare',
    type: 'minion',
  ...
  // ============================================
  {
    ...
    description: 'Dormant for 2 turns.',
  ...
  },
  {
    ...
    race: 'Titan',
    keywords: ['dormant'],
    description: 'After you play 3 minions in a turn, destroy all other minions and awaken.',
    collectible: true,
    set: 'genesis',
    dormantTurns: -1,
    awakenCondition: {
  ...
  },
  {
    ...
    type: 'minion',
    rarity: 'rare',
    description: 'Battlecry and Deathrattle: Give a random friendly minion +3 Attack.',
  ...
  // ============================================
  {
    ...
    attack: 2,
    health: 5,
    description: 'Battlecry: Gain +3 Attack this turn.',
    rarity: 'rare',
    type: 'minion',
    keywords: ['rush', 'battlecry'],
    battlecry: {
  ...
  },
  {
    ...
    attack: 2,
    health: 6,
    description: 'Each turn this is in your hand, swap its Attack and Health.',
    rarity: 'common',
    type: 'minion',
    keywords: ['rush'],
    class: 'Neutral',
  ...
  // ============================================
  {
    ...
    type: 'minion',
    rarity: 'epic',
    description: "Battlecry: Deal damage equal to this minion's Attack split among all enemies.",
  ...
  },
  {
    ...
    type: 'minion',
    rarity: 'epic',
    description: "Colossal +2. Battlecry: Draw 3 Nagas from your deck.",
  ...
  },
  {
    ...
    type: 'minion',
    rarity: 'rare',
    description: "Part of Scylla. Deathrattle: Deal 2 damage to all enemy minions.",
  ...
  },
  {
    ...
    type: 'minion',
    rarity: 'rare',
    description: "Part of Scylla. Battlecry: Give adjacent minions +1/+1.",
  ...
  },
  {
    ...
    type: 'minion',
    rarity: 'epic',
    description: "Colossal +3. Summons three Solar Shields that protect the main body.",
  ...
  },
  {
    ...
    type: 'minion',
    rarity: 'rare',
    description: "Part of Colossus of Rhodes. Can't attack.",
  ...
  },
  {
    ...
    type: 'minion',
    rarity: 'rare',
    description: 'At the end of your turn, add a random Death Knight card to your hand.',
  ...
  },
  {
    ...
    type: 'minion',
    rarity: 'epic',
    description: 'Battlecry: Summon two 1/1 Whelps for your opponent.',
  ...
  },
  {
    ...
    type: 'minion',
    rarity: 'rare',
    description: 'Deathrattle: Summon a 1/2 Slime with Taunt.',
  ...
  },
  {
    ...
    type: 'minion',
    rarity: 'rare',
    description: 'Battlecry: Transform a friendly minion into a 3/3 copy of this with Rush.',
...
const mythologyEpicMinions: CardData[] = [
  ...
  },
  {
    ...
    type: 'minion',
    rarity: 'epic',
    description: 'Battlecry: Deal 2 damage to all other minions.',
...
const mythologyMythicMinions: CardData[] = [
  ...
  },
  {
    ...
    type: 'minion',
    rarity: 'epic',
    description: 'Deathrattle: Equip a 5/3 Ashbringer of Tyr.',
...
const mythologyNorseCards: CardData[] = [
  ...
  },
  {
    ...
    type: 'minion',
    rarity: 'common',
    description: 'Costs (1) less per Attack of your weapon.',
  ...
  },
  {
    ...
    type: 'minion',
    rarity: 'common',
    description: 'Has +1 Attack for each other Naga on the battlefield.',
...
const mythicDragonMinions: CardData[] = [
  ...
  },
  {
    ...
    description: 'Deathrattle: If you\'re holding a Dragon, deal 3 damage to all minions.',
...
const rareBeastMinions: CardData[] = [
  ...
  },
  {
    ...
    description: 'Battlecry: Lose 1 Health for each card in your opponent\'s hand.',
...
const epicBeastMinions: CardData[] = [
  ...
  },
  {
    ...
    description: 'Deathrattle: Shuffle 3 copies of this minion with +3/+3 into your deck.',
  ...
  },
  {
    ...
    description: 'Battlecry: Give all Beasts in your hand +2/+2.',
...
const comboTutorCards: CardData[] = [
  {
    ...
    description: 'Battlecry: Draw a Beast, a Dragon, and a Naga from your deck.',
...
const controlRemovalCards: CardData[] = [
  ...
  },
  {
    ...
    description: 'Battlecry: Your opponent summons a random minion from their hand.',
...
const cheatRecruitRampCards: CardData[] = [
  ...
  },
  {
    ...
    description: 'Overkill: Recruit a Beast.',
...
const synergyPackageCards: CardData[] = [
  ...
  },
  {
    id: 33281,
    name: 'Reborn Spirit',
    description: 'Deathrattle: Give adjacent minions Reborn.',
  ...
  },
  {
    ...
    description: 'After a friendly minion loses Divine Shield, gain +2 Attack.',
