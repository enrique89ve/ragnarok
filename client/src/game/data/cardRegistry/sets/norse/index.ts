...
const norseGods: CardData[] = [
  {
    ...
    attack: 6,
    health: 6,
    description: "Battlecry: Give all friendly minions Divine Shield. Deathrattle: Restore 4 Health to your hero.",
  ...
  },
  {
    ...
    attack: 5,
    health: 10,
    description: "Battlecry: Reveal 3 cards from your deck. Choose one to add to your hand.",
...
const norseMythicCreatures: CardData[] = [
  ...
  },
  {
    ...
    attack: 7,
    health: 7,
    description: "Battlecry: Destroy an enemy minion. At the end of each turn, gain +1 Attack.",
  ...
  },
  {
    ...
    attack: 5,
    health: 6,
    description: "Battlecry: Revive a random friendly minion that died this game with +1/+1. When a friendly minion dies, summon a 2/2 Shadow Hound with Taunt.",
  ...
  },
  {
    ...
    attack: 5,
    health: 5,
    description: "Battlecry: Deal 1 damage to all enemy minions. At the end of your turn, if this has Stealth, give another random friendly minion Stealth.",
  ...
  },
  {
    ...
    attack: 8,
    health: 8,
    description: "Battlecry: Destroy all enemy minions with 2 or less Health. At the end of each turn, deal 1 damage to all enemy minions.",
  ...
  },
  {
    ...
    attack: 4,
    health: 4,
    description: "Battlecry: Summon two 2/2 Shadow Wolves with Stealth. Whenever you summon a Shadow Wolf, give it +1/+1.",
  ...
  },
  {
    ...
    attack: 6,
    health: 6,
    description: "Battlecry: Destroy an enemy minion with 4 or less Attack and summon a 3/3 Shadow Wolf in its place. After this attacks and kills a minion, summon a 1/1 Shadow Pup with Stealth.",
  ...
  },
  {
    ...
    attack: 10,
    health: 14,
    description: "Can't be Silenced. Cannot have Attack reduced. Takes 1 less damage. Whenever this attacks, deal 3 damage to all other minions.",
  ...
  },
  {
    ...
    attack: 9,
    health: 9,
    description: "Battlecry: Enemy minions have -2 Attack while this is alive. Whenever this deals damage, restore that much Health to your hero.",
  ...
  },
  {
    ...
    attack: 6,
    health: 12,
    description: "Your opponent's minions have -1 Attack. At the end of your turn, gain +2 Health.",
  ...
  },
  {
    ...
    attack: 7,
    health: 11,
    description: "Battlecry: Disable all enemy minion abilities until your next turn. Whenever this deals damage, restore 3 Health to it.",
  ...
  },
  {
    ...
    attack: 7,
    health: 7,
    description: "Whenever a minion dies, gain +1 Attack. After this kills a minion, gain Stealth until your next turn.",
  ...
  },
  {
    ...
    attack: 6,
    health: 13,
    description: "Whenever this takes damage, restore 2 Health to it. Battlecry: Destroy a random enemy minion.",
...
const fireElementLegendaries: CardData[] = [
  ...
  },
  {
    ...
    attack: 7,
    health: 8,
    description: "At the end of your turn, deal 1 damage to all enemies.",
  ...
  },
  {
    ...
    attack: 5,
    health: 5,
    description: "Battlecry: Give a friendly minion +2/+2 and 'Deathrattle: Summon a 2/2 Glóð's Spark.'",
  ...
  },
  {
    ...
    attack: 6,
    health: 4,
    description: "Battlecry: Deal 3 damage to an enemy. If this kills them, gain Immune this turn.",
...
const earthElementLegendaries: CardData[] = [
  {
    ...
    attack: 5,
    health: 6,
    description: "Battlecry: Give adjacent minions +1/+2. When this takes damage, give a random friendly minion +1 Health.",
  ...
  },
  {
    ...
    attack: 8,
    health: 8,
    description: "Battlecry: Gain +1/+1 for each card in your hand. Deathrattle: Draw 2 cards.",
  ...
  },
  {
    ...
    attack: 4,
    health: 5,
    description: "Battlecry: Summon a 1/3 Yggdrasil's Tendril with Taunt for each other friendly minion.",
  ...
  },
  {
    ...
    attack: 6,
    health: 10,
    description: "At the end of your turn, restore 2 Health to this minion and give it +1 Attack.",
  ...
  },
  {
    ...
    attack: 7,
    health: 14,
    description: "Battlecry: Restore 5 Health to your hero. At the end of each turn, gain +2 Health.",
  ...
  },
  {
    ...
    attack: 5,
    health: 6,
    description: "Can't be targeted by spells or Hero Powers. At the start of your turn, gain +1 Health.",
...
const holyElementLegendaries: CardData[] = [
  {
    ...
    attack: 3,
    health: 3,
    description: "Battlecry: Draw a card. If Muninn is in play, draw 2 instead.",
  ...
  },
  {
    ...
    attack: 3,
    health: 3,
    description: "Battlecry: Return a card from your graveyard to your hand. If Huginn is in play, return 2 instead.",
...
const waterElementLegendaries: CardData[] = [
  ...
  },
  {
    ...
    attack: 4,
    health: 6,
    description: "Battlecry: Freeze an enemy. If it's already frozen, destroy it instead.",
  ...
  },
  {
    ...
    attack: 3,
    health: 5,
    description: "At the start of your turn, transform into a copy of a random enemy minion.",
...
const lightningElementLegendaries: CardData[] = [
  {
    ...
    attack: 4,
    health: 3,
    description: "Has +1 Attack for each other friendly Lightning minion.",
  ...
  },
  {
    ...
    attack: 5,
    health: 6,
    description: "Your other Flying minions have +1 Attack. Battlecry: Reduce the Attack of all enemy minions by 2 until end of turn.",
  ...
  },
  {
    ...
    attack: 5,
    health: 5,
    description: "Battlecry: Deal 3 damage to all enemy minions and stun them for one turn. Gains +1 Attack when dealing damage to multiple enemies.",
  ...
  },
  {
    ...
    attack: 5,
    health: 4,
    description: "Each time this minion attacks, reduce the cost of your next spell by 1.",
...
const darkMinions: CardData[] = [
  ...
  },
  {
    ...
    attack: 3,
    health: 4,
    description: "Battlecry: Deal 2 damage to an enemy minion and apply Poison (1 damage at end of turn).",
  ...
  },
  {
    ...
    attack: 4,
    health: 4,
    description: "Passive: When attacking from Stealth, deal 1 extra damage. Battlecry: Deal 3 damage to an enemy.",
...
const lightMinions: CardData[] = [
  ...
  },
  {
    ...
    attack: 4,
    health: 4,
    description: "When this attacks, give a friendly minion +1 Attack.",
  ...
  },
  {
    ...
    attack: 3,
    health: 5,
    description: "Battlecry: Restore 3 Health to this minion.",
...
const neutralMinions: CardData[] = [
  {
    ...
    attack: 1,
    health: 3,
    description: "Battlecry: Gain +2 Health this turn.",
  ...
  },
  {
    ...
    attack: 4,
    health: 4,
    description: "Battlecry: Gain +2 Attack this turn.",
  ...
  },
  {
    ...
    attack: 3,
    health: 3,
    description: "Battlecry: Deal 2 damage to an enemy minion with 2 or less Health.",
  ...
  },
  {
    ...
    attack: 3,
    health: 6,
    description: "Passive: When attacked, reduce damage taken by 1. Battlecry: Gain +3 Health this turn.",
...
const greekLegendaries: CardData[] = [
  ...
  },
  {
    ...
    attack: 3,
    health: 4,
    description: "Battlecry: Look at the top 3 cards of your deck. Draw one. When you draw a card, give a random friendly minion +1 Attack.",
